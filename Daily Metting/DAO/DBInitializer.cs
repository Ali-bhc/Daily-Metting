        ...
        public static void Seed(IApplicationBuilder applicationBuilder)
        {
            ...
            if (!context.Points.Any())
            {
                ...
                (
                    ...
                    //Quality
                    new Point { Point_Name = "Cutomer Claims", WH_Acces = false, CS_PP_Acces = true, Procurement_Acces = false, HasMultipleValues = false, Category = Categories["Quality"] },
                    ...
                    //Delivery
                    new Point { Point_Name = "Cutomer Escallation", WH_Acces = false, CS_PP_Acces = true, Procurement_Acces = false, HasMultipleValues = false, Category = Categories["Delivery"] },
